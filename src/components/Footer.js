...
const Footer = () => {
  return (
    <footer className="mt-24">
      <div className="container-fluid footer flex">
        <ul className="footer__nav-links flex md:space-x-10 uppercase text-white">
          <li>
            <svg
        ...
        <ul className="footer__social-links flex space-x-4 ml-auto">
          <li>
            <a
              href="https://github.com/mohdimran001"
              target="_blank"
              rel="noreferrer"
            >
              <svg
          ...
          <li className="pt-1">
            <a
              href="https://twitter.com/mohdimran05"
              target="_blank"
              rel="noreferrer"
            >
              <svg
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/mohdimran001"
              target="_blank"
              rel="noreferrer"
            >
              <svg
