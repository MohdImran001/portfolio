...
const GetInTouch = () => {
  return (
    <div className="get-in-touch sm:mt-10 md:mt-20">
      ...
      <p className="text">
        ...
        Delhi. But I’m also happy to hear about opportunites that don’t fit that
        ...
        <ul className="get-in-touch__icons flex space-x-4 mt-6">
          <li>
            <a
